 ...
 ******************/
  ...
  router.get(base+'skip/tasklist-variation-lb-nondetermination', function (req, res) {
    req.session.data["appealsub-v16-bys-planningdepartment"] = "BRD";
    req.session.data["appealsub-v16-bys-whatareyouappealing"] = "Removal or variation of conditions";
    req.session.data["appealsub-v16-bys-removalvariationconditions"] = "Listed building consent";
    req.session.data["appealsub-v16-bys-route"] = "listedbuilding";
    req.session.data["appealsub-v16-bys-appealabout"] = "No";
    req.session.data["appealsub-v16-bys-permissiongrantedrefused"] = "I have not received a decision";
    req.session.data["appealsub-v16-bys-decisiondatedue-day"] = "05";
    req.session.data["appealsub-v16-bys-decisiondatedue-month"] = "05";
    req.session.data["appealsub-v16-bys-decisiondatedue-year"] = "2022";
    req.session.data["appealsub-v16-bys-deadline-day"] = 3;
    req.session.data["appealsub-v16-bys-deadline-month"] = 11;
    req.session.data["appealsub-v16-bys-deadline-year"] = 2022;
    req.session.data["appealsub-v16-bys-enforcementnotice"] = "No";
    req.session.data["savereturn-v16-applicationnumber"] = "987654321";
    req.session.data["savereturn-v16-email"] = "name@email.com";
    res.redirect(base+'listed-building/task-list');
  })
 ...
 ***********************/
  ...
  router.post(base+'save-return/input-code', function (req, res) {
    if (req.session.data["savereturn-"+v+"-code"] == "406257"){
      res.redirect(base+'listed-building/task-list');
