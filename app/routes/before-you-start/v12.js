 ...
 ************************/
   ...
   */
   ...
   router.post('/appealtype-v12', function (req, res) {
     ...
     if (appealing === 'planning') {
       res.redirect('/mvp-full-appeal/v2/before-you-start/planning-department')
     } else if (appealing === 'listedenforcement') {
  ...
  *** PREVIOUS BEFORE YOU START WORK ****
  ***************************************/
