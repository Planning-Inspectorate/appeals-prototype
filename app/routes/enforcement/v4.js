module.exports = function (router) {
    ...
    ******************************/
    ...
    router.post(base+'named-on-notice/who-are-you', function (req, res) {
      ...
      if (user === 'appellant') {
        ...
        res.redirect('/enforcement/v4/named-on-notice/who-was-served')
      }
    })
  ...
  router.post(base+'named-on-notice/named-on-notice', function (req, res) {
    ...
    // route depending on value
    if (identity === 'company') {
      res.redirect('/enforcement/v4/named-on-notice/company-name')
    } else {
      res.redirect('/enforcement/v4/named-on-notice/person-name')
    }
  ...
  // Enforcement
  // Additional people
  router.post(base+'named-on-notice/additional-people-v4', function (req, res) {
  ...
  router.post('/sitevisible', function (req, res) {
    ...
    if (visibility === 'yes') {
      ...
      res.redirect('/enforcement/v4/appeal-site/postcode-address')
    }
  })
  ...
  router.post(base+'appeal-site/owner-consent', function (req, res) {
    ...
    // route depending on value
    if (interest === 'Yes') {
      res.redirect('/enforcement/v4/appeal-site/site-occupation')
    } else {
      res.redirect('/enforcement/v4/appeal-site/your-interest')
    }
  })
  ...
  router.post(base+'appeal-site/otherappeals-v4', function (req, res) {
    req.session.data["enforcement-taskliststatus-appealsite"] = "Complete";
    res.redirect('/enforcement/v4/task-list')
  })
  ...
  router.post('/applicationmade-v4', function (req, res) {
    ...
    if (application === 'Yes') {
      res.redirect('/enforcement/v4/grounds/application-date')
    } else {

      if ( groundA === 'Yes') {
        res.redirect('/enforcement/v4/grounds/fees')
      } else {
  ...
  router.post('/applicationdecision-v4', function (req, res) {
    ...
    if (decisionreceived === 'Yes') {
      ...
      res.redirect('/enforcement/v4/grounds/application-decision-date')
  ...
  // Enforcement
  // Fees paid
  router.post('/feespaid-v4', function (req, res) {
    ...
    if (feespaid === 'Yes') {
      ...
      res.redirect('/enforcement/v4/grounds/fees-exempt')
    }
  })
  ...
  router.post(base+'procedure/procedure', function (req, res) {
    ...
    if (how === 'Written representations') {
      ...
      res.redirect('/enforcement/v4/procedure/hearing')
    } else {
      res.redirect('/enforcement/v4/procedure/inquiry')
    }
  })
  ...
  router.post(base+'upload/planning-obligation', function (req, res) {
    ...
    // route depending on value
    if (obligation === 'Yes') {
      res.redirect('/enforcement/v4/upload/planning-obligation-status')
    } else {
      res.redirect('/enforcement/v4/upload/supporting-documents')
    }
  })
  ...
  router.post(base+'upload/planning-obligation-status', function (req, res) {
    ...
    if (obligationstatus === 'Finalised and ready to submit') {
      res.redirect('/enforcement/v4/upload/obligation-ready')
    } else if (obligationstatus === 'In draft') {
      res.redirect('/enforcement/v4/upload/obligation-draft')
    } else {
      res.redirect('/enforcement/v4/upload/obligation-not-started')
    }
  })
  ...
  router.post(base+'upload/enforcement-notice', function (req, res) {
    res.redirect('/enforcement/v4/upload/planning-obligation')
  })
  ...
  router.post(base+'upload/supporting-documents-v4', function (req, res) {
    ...
    if (supportingdocuments === 'Yes') {
      res.redirect('/enforcement/v4/upload/additional-documents')
    } else {
      req.session.data["enforcement-taskliststatus-appealdocuments"] = "Complete";
      res.redirect('/enforcement/v4/task-list')
    }
  ...
  router.get(base+'skip/appeal-start', function (req, res) {
    ...
    res.redirect('/enforcement/v4/before-you-continue')
  })
