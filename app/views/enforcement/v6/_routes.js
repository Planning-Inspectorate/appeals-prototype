...
const router = new express.Router()
    ...
    ******************************/
    ...
    router.post('/named-on-notice/who-are-you', function (req, res) {
      ...
      if (user === 'appellant') {
        res.redirect('/enforcement/v6/named-on-notice/named-on-notice')
      } else {
        res.redirect('/enforcement/v6/named-on-notice/who-was-served')
      }
    })
  ...
  router.post('/named-on-notice/finish-named-on-notice', function (req, res) {
    ...
    res.redirect('/enforcement/v6/task-list')
  })
  ...
  router.post('/named-on-notice/named-on-notice', function (req, res) {
    ...
    // route depending on value
    if (identity === 'company') {
      res.redirect('/enforcement/v6/named-on-notice/company-name')
    } else {
      res.redirect('/enforcement/v6/named-on-notice/person-name')
    }
  ...
  // Additional people
  router.post('/named-on-notice/additional-people-v6', function (req, res) {
    ...
    // route depending on value
    if (addedpeople === 'Yes') {
      res.redirect('/enforcement/v6/named-on-notice/add-person')
    } else {
      req.session.data["enforcement-taskliststatus-named-on-notice"] = "Complete";
      res.redirect('/enforcement/v6/task-list?enforcement-taskliststatus-contactdetails=Complete')
    }
  })
  ...
  // Additional people
  router.post('/named-on-notice/added-names-v6', function (req, res) {
  ...
  router.post('/finishnoticename', function (req, res) {
    ...
    req.session.data["enforcement-taskliststatus-contactdetails"] = "Complete";
    res.redirect('/enforcement/v6/task-list?enforcement-taskliststatus-appealsite=Complete')
  ...
  router.post('/sitevisible', function (req, res) {
    ...
    if (visibility === 'yes') {
      ...
      res.redirect('/enforcement/v6/appeal-site/postcode-address')
    }
  })
  ...
  // Site interest
  router.post('/appeal-site/siteinterest-v6', function (req, res) {
    ...
    // route depending on value
    if (interest === 'none') {
      res.redirect('/enforcement/v6/appeal-site/owner-consent')
    } else {
      res.redirect('/enforcement/v6/appeal-site/other-appeals')
    }
  })
  ...
  router.post('/appeal-site/owner-consent', function (req, res) {
    ...
    // route depending on value
    if (interest === 'Yes') {
      res.redirect('/enforcement/v6/appeal-site/site-occupation')
    } else {
      res.redirect('/enforcement/v6/appeal-site/your-interest')
    }
  })
  ...
  router.post('/grounds/reasons-a', function (req, res) {
    res.redirect('supporting-check-a')
  })

  router.post('/grounds/supporting-check-a', function (req, res) {
    let check = req.session.data['supporting-check-a']
    let groundB = req.session.data['grounds-2']
    let groundC = req.session.data['grounds-3']
    let groundD = req.session.data['grounds-4']
    let groundE = req.session.data['grounds-5']
  ...
  router.post('/grounds/supporting-upload-a', function (req, res) {
    let groundB = req.session.data['grounds-2']
    let groundC = req.session.data['grounds-3']
    let groundD = req.session.data['grounds-4']
    let groundE = req.session.data['grounds-5']
  ...
  router.post('/grounds/supporting-check-b', function (req, res) {
    let check = req.session.data['supporting-check-b']
    let groundC = req.session.data['grounds-3']
    let groundD = req.session.data['grounds-4']
    let groundE = req.session.data['grounds-5']
    let groundF = req.session.data['grounds-6']
  ...
  router.post('/grounds/supporting-upload-b', function (req, res) {
    let groundC = req.session.data['grounds-3']
    let groundD = req.session.data['grounds-4']
    let groundE = req.session.data['grounds-5']
    let groundF = req.session.data['grounds-6']
  ...
  router.post('/grounds/supporting-check-c', function (req, res) {
    let check = req.session.data['supporting-check-c']
    let groundD = req.session.data['grounds-4']
    let groundE = req.session.data['grounds-5']
    let groundF = req.session.data['grounds-6']
    let groundG = req.session.data['grounds-7']
  ...
  router.post('/grounds/supporting-upload-c', function (req, res) {
    let groundD = req.session.data['grounds-4']
    let groundE = req.session.data['grounds-5']
    let groundF = req.session.data['grounds-6']
    let groundG = req.session.data['grounds-7']
  ...
  router.post('/grounds/supporting-check-d', function (req, res) {
    let check = req.session.data['supporting-check-d']
    let groundE = req.session.data['grounds-5']
    let groundF = req.session.data['grounds-6']
    let groundG = req.session.data['grounds-7']
  ...
  router.post('/grounds/supporting-upload-d', function (req, res) {
    let groundE = req.session.data['grounds-5']
    let groundF = req.session.data['grounds-6']
    let groundG = req.session.data['grounds-7']
  ...
  router.post('/grounds/supporting-check-e', function (req, res) {
    let check = req.session.data['supporting-check-e']
    let groundF = req.session.data['grounds-6']
    let groundG = req.session.data['grounds-7']
  ...
  router.post('/grounds/supporting-upload-e', function (req, res) {
    let groundF = req.session.data['grounds-6']
    let groundG = req.session.data['grounds-7']
  ...
  router.post('/grounds/supporting-check-f', function (req, res) {
    let check = req.session.data['supporting-check-f']
    let groundG = req.session.data['grounds-7']
  ...
  router.post('/grounds/supporting-upload-f', function (req, res) {
    let groundG = req.session.data['grounds-7']
  ...
  router.post('/grounds/supporting-check-g', function (req, res) {
    let check = req.session.data['supporting-check-g']
  ...
  router.post('/grounds/supporting-upload-g', function (req, res) {
    res.redirect('application')
  })
  //---- /GROUND G
  ...
  router.post('/grounds/application', function (req, res) {
    ...
    if (application === 'Yes') {
      res.redirect('/enforcement/v6/grounds/application-date')
    } else {

      if ( groundA === 'Yes') {
        res.redirect('/enforcement/v6/grounds/fees')
      } else {
  ...
  router.post('/grounds/application-decision', function (req, res) {
    ...
    if (decisionreceived === 'Yes') {
      ...
      res.redirect('/enforcement/v6/grounds/application-decision-date')
  ...
  router.post('/grounds/fees', function (req, res) {
    ...
    if (feespaid === 'Yes') {
      ...
      res.redirect('/enforcement/v6/grounds/fees-exempt')
    }
  })
  ...
  router.post('/procedure/procedure', function (req, res) {
    ...
    if (how === 'Written representations') {
      ...
      res.redirect('/enforcement/v6/procedure/hearing')
    } else {
      res.redirect('/enforcement/v6/procedure/inquiry')
    }
  })
  ...
  router.post('/upload/planning-obligation', function (req, res) {
    ...
    // route depending on value
    if (obligation === 'Yes') {
      res.redirect('/enforcement/v6/upload/planning-obligation-status')
    } else {
      res.redirect('/enforcement/v6/upload/supporting-documents')
    }
  })
  ...
  router.post('/upload/planning-obligation-status', function (req, res) {
    ...
    if (obligationstatus === 'Finalised and ready to submit') {
      res.redirect('/enforcement/v6/upload/obligation-ready')
    } else if (obligationstatus === 'In draft') {
      res.redirect('/enforcement/v6/upload/obligation-draft')
    } else {
      res.redirect('/enforcement/v6/upload/obligation-not-started')
    }
  })
  ...
  router.post('/upload/enforcement-notice', function (req, res) {
    res.redirect('/enforcement/v6/upload/planning-obligation')
  })
  ...
  router.post('/upload/supporting-documents-v6', function (req, res) {
    ...
    if (supportingdocuments === 'Yes') {
      res.redirect('/enforcement/v6/upload/additional-documents')
    } else {
      req.session.data["enforcement-taskliststatus-appealdocuments"] = "Complete";
      res.redirect('/enforcement/v6/task-list')
    }
  ...
  router.get('/skip/appeal-start', function (req, res) {
    ...
    res.redirect('/enforcement/v6/before-you-continue')
  })
