...
router.post('/contact-details/who-are-you', function (req, res) {
  ...
  if (user === 'appellant') {
    res.redirect('/enforcement-2022/v8/contact-details/contact-details')
  } else {
    res.redirect('/enforcement-2022/v8/contact-details/who-was-served')
  }
})
...
router.post('/contact-details/finish-contact-details', function (req, res) {
  ...
  res.redirect('/enforcement-2022/v8/task-list')
})
...
router.post('/contact-details/contact-details', function (req, res) {
  ...
  // route depending on value
  if (identity === 'company') {
    res.redirect('/enforcement-2022/v8/contact-details/company-name')
  } else {
    res.redirect('/enforcement-2022/v8/contact-details/person-name')
  }
...
router.post('/contact-details/company-name', function (req, res) {
  res.redirect('/enforcement-2022/v8/contact-details/added-names')
})
...
router.post('/contact-details/added-names', function (req, res) {
  ...
  if (addedpeople === 'Yes') {
    if (applicant === 'You') {
      res.redirect('/enforcement-2022/v8/contact-details/application-check')
    } else {
      res.redirect('/enforcement-2022/v8/contact-details/application-check?else')
    }
  } else {
    req.session.data["enforcement-taskliststatus-contactdetails"] = "Complete";
    res.redirect('/enforcement-2022/v8/task-list?enforcement-taskliststatus-contactdetails=Complete')
  }
})
...
router.post('/finishnoticename', function (req, res) {
  ...
  req.session.data["enforcement-taskliststatus-contactdetails"] = "Complete";
  res.redirect('/enforcement-2022/v8/task-list?enforcement-taskliststatus-appealsite=Complete')
...
router.post('/sitevisible', function (req, res) {
  ...
  if (visibility === 'yes') {
    ...
    res.redirect('/enforcement-2022/v8/site-address/postcode-address')
  }
})
...
router.post('/site-address/site-interest', function (req, res) {
  ...
  // route depending on value
  if (interest === 'none') {
    res.redirect('/enforcement-2022/v8/site-address/owner-consent')
  } else {
    res.redirect('/enforcement-2022/v8/site-address/other-appeals')
  }
})
...
router.post('/site-address/owner-consent', function (req, res) {
  ...
  // route depending on value
  if (interest === 'Yes') {
    res.redirect('/enforcement-2022/v8/site-address/site-occupation')
  } else {
    res.redirect('/enforcement-2022/v8/site-address/your-interest')
  }
})
...
router.post('/grounds/application', function (req, res) {
  ...
  if (application === 'Yes') {
    res.redirect('/enforcement-2022/v8/grounds/application-date')
  } else {

    if ( groundA === 'Yes') {
      res.redirect('/enforcement-2022/v8/grounds/fees')
    } else {
...
router.post('/grounds/application-decision', function (req, res) {
  ...
  if (decisionreceived === 'Yes') {
    ...
    res.redirect('/enforcement-2022/v8/grounds/application-decision-date')
...
router.post('/grounds/fees', function (req, res) {
  ...
  if (feespaid === 'Yes') {
    ...
    res.redirect('/enforcement-2022/v8/grounds/fees-exempt')
  }
})
...
router.post('/procedure/procedure', function (req, res) {
  ...
  if (how === 'Written') {
    ...
    res.redirect('/enforcement-2022/v8/procedure/hearing')
  } else {
    res.redirect('/enforcement-2022/v8/procedure/inquiry')
  }
})
...
router.post('/upload/planning-obligation', function (req, res) {
  ...
  // route depending on value
  if (obligation === 'Yes') {
    res.redirect('/enforcement-2022/v8/upload/planning-obligation-status')
  } else {
    res.redirect('/enforcement-2022/v8/upload/supporting-documents')
  }
})
...
router.post('/upload/planning-obligation-status', function (req, res) {
  ...
  if (obligationstatus === 'Finalised and ready to submit') {
    res.redirect('/enforcement-2022/v8/upload/obligation-ready')
  } else if (obligationstatus === 'In draft') {
    res.redirect('/enforcement-2022/v8/upload/obligation-draft')
  } else {
    res.redirect('/enforcement-2022/v8/upload/obligation-not-started')
  }
})
...
router.post('/upload/enforcement-notice', function (req, res) {
  res.redirect('/enforcement-2022/v8/upload/planning-obligation')
})
...
router.post('/upload/supporting-documents-v8', function (req, res) {
  ...
  if (supportingdocuments === 'Yes') {
    res.redirect('/enforcement-2022/v8/upload/additional-documents')
  } else {
    req.session.data["enforcement-taskliststatus-appealdocuments"] = "Complete";
    res.redirect('/enforcement-2022/v8/task-list')
  }
...
router.get('/skip/appeal-start', function (req, res) {
  ...
  res.redirect('/enforcement-2022/v8/before-you-continue')
})
