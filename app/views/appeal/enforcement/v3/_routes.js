...
router.post('/prepare-appeal/address', function (req, res) {
  res.redirect('address-check?site-details-started=true')
})
...
router.post('/prepare-appeal/interest-in-site', function (req, res) {
  res.redirect('description-of-land?site-details-started=true')
})
...
router.post('/prepare-appeal/procedure', function (req, res) {
  if (req.session.data['procedure'] == 'Inquiry') {
    res.redirect('reason-inquiry?application-started=true')
  } else if (req.session.data['procedure'] == 'Hearing'){
    res.redirect('reason-hearing?application-started=true')
  }
  else {
    res.redirect('other-appeals-check?application-started=true')
  }
})
...
router.post('/prepare-appeal/description-of-breach', function (req, res) {
  res.redirect('grounds?your-application-started')
})
...
router.post('/prepare-appeal/grounds', function (req, res) {
  ...
  if (grounds && (grounds.includes && grounds.includes('groundA'))) {
    res.redirect('submit-planning-application?your-application-started');
  } else {
    // Otherwise, go to facts-b
    res.redirect('facts-b?your-application-started');
  }
})
...
router.post('/upload-documents/upload-enforcement-notice', function (req, res) {
  res.redirect('upload-enforcement-plan?application-started=true')
})
