...
router.post('/prepare-appeal/supporting-check-b', function (req, res) {
  if (req.session.data['supporting-check-b'] == 'Yes') {
    req.session.data['_supporting-docs-b'] = req.body['_supporting-docs-b'];
    req.session.data['_supporting-docs-b-complete'] = true;
...
router.post('/prepare-appeal/decision-letter-date', function (req, res) {
  res.redirect('submit-appeal')
})

router.post('/prepare-appeal/submit-appeal', function (req, res) {
  if (req.session.data['submit-appeal'] == 'Yes') {
...
router.post('/prepare-appeal/submit-apeal', function (req, res) {
  res.redirect('appeal-decision')
})
...
router.post('/prepare-appeal/ground-a-fee-upload', function (req, res) {
  req.session.data['ground-a-fee-upload-complete'] = true;
  res.redirect('facts-a')
})
